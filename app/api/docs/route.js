export async function GET() {
  const openApiSpec = {
    ...
    info: {
      title: '-catalog API',
      version: '1.0.0',
      description: 'Discovery and health endpoints for -catalog',
      termsOfService: 'https://-catalog.platphormnews.com/terms'
    },
    servers: [
      { url: 'https://-catalog.platphormnews.com', description: 'Production' }
    ],
    paths: {
