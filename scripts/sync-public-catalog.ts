...
async function main() {
  ...
  const scanMeta = await readJson<{
    generatedAt?: string
  }>(path.join(generatedDir, "catalog-scan-meta.json")).catch(() => ({ generatedAt: undefined }))
  ...
  await writeJson(path.join(publicDir, "llms-index.json"), {
    ...
    routes: {
      ...
      catalog_census: "/api/v1/catalog/census",
      catalog_dependencies: "/api/v1/catalog/dependencies",
      catalog_technologies: "/api/v1/catalog/technologies",
      catalog_publications: "/api/v1/catalog/publications",
      catalog_publications_filename: "/api/v1/catalog/publications/{filename}",
      catalog_scans: "/api/v1/scans",
      catalog_route_compliance: "/api/v1/route-compliance",
