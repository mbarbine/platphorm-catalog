# mbarbine__v0-2025-year-in-review

*Automatically synced with your [v0.app](https://v0.app) deployments*

## Metadata

- ID: `github-recent__mbarbine__v0-2025-year-in-review`
- Path: `/Users/bwm.barbinewarnermichael/Documents/github/repositories/github-recent/mbarbine__v0-2025-year-in-review`
- Remote: `git@github.com:mbarbine/v0-2025-year-in-review.git`
...
- Confidence: medium
- Reuse: partial, difficulty medium
- Source paths: `components/achievement-card.tsx`, `components/share-card.tsx`, `components/stat-counter.tsx`, `components/theme-provider.tsx`, `components/ui/button.tsx`, `components/ui/card.tsx`
- Tests: none detected
- LLMs context: none detected
