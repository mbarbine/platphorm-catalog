# mbarbine__biocyber-xr-training-nasa-webby-v0
...
- Remote: `git@github.com:mbarbine/biocyber-xr-training-nasa-webby-v0.git`
...
- Confidence: medium
- Reuse: partial, difficulty medium
- Source paths: `components/theme-provider.tsx`, `components/ui/button.tsx`, `components/ui/card.tsx`
- Tests: none detected
- LLMs context: none detected
